...
mod tests {
    ...
    #[test]
    fn test_part_one() {
        let input = utils::get_test_input(2021, 1, 1);
        let parsed_input = parse_input(&input);
        let expected = utils::get_test_result(2021, 1, 1, 1).parse().unwrap();
    ...
    fn test_part_two() {
        let input = utils::get_test_input(2021, 1, 1);
        let parsed_input = parse_input(&input);
        let expected = utils::get_test_result(2021, 1, 2, 1).parse().unwrap();
